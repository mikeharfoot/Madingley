...
namespace Madingley
{
    ...
    public static class Utilities
    {
        ...
        public static uint[] RandomlyOrderedIndices(uint numberIndices)
        {
        ...
        public static uint[] NonRandomlyOrderedCohorts(uint cohortNumber, uint currentTimeStep)
        {
        ...
        public static int[] FindJaggedArrayIndex(uint valueToFind, uint[][] arrayToSearch, uint totalNumberOfCohorts)
        {
        ...
        public static double CalculateLengthOfDegreeLatitude(float latitude)
        {
            // Convert from degrees to radians
            double latitudeRad = DegreesToRadians(latitude);
        ...
        public static double CalculateLengthOfDegreeLongitude(float latitude)
        {
            // Convert from degrees to radians
            double latitudeRad = DegreesToRadians(latitude);
