...
namespace Madingley
{
    ...
    public static class CVC
    {
        ...
        public static Tuple<double[], double, double> MonthlyActualEvapotranspirationSoilMoisture(double AvailableWaterCapacity, double[] Precipitation, double[] MonthlyTemperatures)
        {
        ...
        public static double CalculatePotentialEvapotranspiration(double Temperature)
        {
        ...
        public static double GetNDF(double[] monthlyFrostDays, double[] monthlyTemperature, double missingValue)
        {
        ...
        private static double ApproximateNDF(double[] MATData)
        {
            int PrevMonth;
            int NextMonth;
            double NDF = 0;
