...
namespace Madingley
{
    ...
    public class CrossCellProcessTracker
    {
        ...
        /// </summary>
        public Madingley.Common.RecordDispersalForACellData[] RecordDispersalForACellData { get; set;}
        ...
        public void RecordDispersalForACell(uint[, ,] inboundCohorts, uint[, ,] outboundCohorts, List<double>[,] outboundCohortWeights, uint timestep, ModelGrid madingleyModelGrid)
        {
            ...
            var copy = new Madingley.Common.RecordDispersalForACellData[count];
            ...
            for (var kk = 0; kk < count; kk++)
            {
                ...
                copy[kk] = new Madingley.Common.RecordDispersalForACellData(enter, exit, weights, ccell);
            }

            this.RecordDispersalForACellData = copy;
        }
    }
}
